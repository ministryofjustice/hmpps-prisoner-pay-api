...
values ('RSI', 'LONG_TERM_SICK', '2025-01-01', 60, now(), 'USER1'),
       ('RSI', 'LONG_TERM_SICK', '2026-01-16', 70, now(), 'USER1'),
       ('RSI', 'LONG_TERM_SICK', '2026-01-21', 80, now(), 'USER1'),
       ('BCI', 'LONG_TERM_SICK', '2026-01-25', 80, now(), 'USER1');
