# hmpps-prisoner-pay-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-prisoner-pay-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-prisoner-pay-api)
...
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://prisoner-pay-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-prisoner-pay-api/security/policy).
...
## Renaming from HMPPS Prisoner Pay Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-prisoner-pay-api=0
```
